# -*- coding: utf-8 -*-
#
# pyramid-excel documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'pyramid-excel', u'pyramid-excel Documentation',
   u'C. W.', 'pyramid-excel', 'One line description of project.',
   'Miscellaneous'),
]
