...
system("moban -cd {0} -td {1} .moban.d -t docs/source/conf.py -o docs/source/conf.py -c moban.yaml".format(config_dir, template_dir))
...
system("moban -cd {0} -td {1} .moban.d -t docs/source/index.rst.jj2 -o docs/source/index.rst -c moban.yaml".format(config_dir, template_dir))
